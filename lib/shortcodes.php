...
class tdPix_shortcodes {
    ...
    function show_tdPix($atts) {
        ...
        $out = '<span><iframe class="phereoframe"  src="http://phereo.com/a/embed/' . $id . '/' . $mode . '/' . $width . '.' . $height . '/important" width="' . $width . '" height="' . $height . '" frameborder="1" vspace="0" hspace="0" marginwidth="0" marginheight="0" scrolling="no" noresize><p class="pherotagline">See stereo 3D on <a href="http://phereo.com">Phereo</a>.</p></iframe></span>';
